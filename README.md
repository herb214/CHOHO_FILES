...
| KIT DE DISTRIBUCIÓN CHOHO | https://herb214.github.io/CHOHO_FILES/kit-distribucion-choho/ | `public/kit-distribucion-choho/entry-qr.png` |

Each QR encodes the **entry URL** (not the PDF). Each entry has **Download from Google Drive** and **Open PDF directly**.

Google Drive links live in each folder’s `google-drive-link.txt`.
